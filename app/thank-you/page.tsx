...
export const metadata: Metadata = {
  ...
  description: 'Your resource is on its way. Book a call to see if you qualify for our guarantee.',
  robots: 'noindex, nofollow', // Don't index thank you pages
};

export default function ThankYouPage_Route() {
  return (
    <ThankYouPage
      headline="Your Resource Is On Its Way. But First..."
